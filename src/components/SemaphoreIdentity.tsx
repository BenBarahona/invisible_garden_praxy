...
export function SemaphoreIdentity({
  ...
  // Auto-generate proof when certificate is verified
  useEffect(() => {
    if (
      autoGenerateProof &&
      identity &&
      ...
      handleGenerateZKProofClick();
    }
  }, [autoGenerateProof, identity, hasAutoGenerated, isGeneratingProof]);
