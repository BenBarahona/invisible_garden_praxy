...
contract Gatekeeper is SignUpGatekeeper, Ownable(msg.sender) {
    ...
    constructor(
        uint256 _validEventId,
        uint256 _validSigner1,
        uint256 _validSigner2,
        address _verifier
    ) payable {
    ...
    function register(address _user, bytes memory _data) public override {
        ...
        if (_pubSignals[13] != validSigner1 || _pubSignals[14] != validSigner2)
